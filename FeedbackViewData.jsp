...
<li><a href="FeedbackPatientDash.jsp"><img class="Back" src="media/Back.png">Back</a></li>
<li><a href="FeedbackReport.jsp">Report</a></li>
</ul>
</div>
...
String strQuery = "SELECT COUNT(*) FROM feedback";
ResultSet rs = st.executeQuery(strQuery);
String Countrow="";
while(rs.next()){
Countrow = rs.getString(1);
out.println("<h4>Total Number Of Feedbacks:<h4>"+Countrow);
}
}
catch (Exception e){
e.printStackTrace();
...
<td><a href="FeedbackDeleteData.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete" >Delete</button></a></td>
<td><a href="FeedbackUpdate.jsp?id=<%=resultSet.getString("id")%>"><button type="button" class="update" >Update</button></a>
</tr>
<%
i++;
}
