...
<li><a href="ViewMarks.jsp"><img class="Back" src="media/Back.png">Back</a></li>
</ul>
</div>
...
<form method="post" action="MarkUpdateProcess.jsp">


ID Number :<br>
<input type="number" name="id"  value="<%=resultSet.getString("id") %>"readonly>
<br>
Name:<br>
...
<form method="post" action="ViewMarks.jsp">
    <button type="submit" class="buttoncss">View</button>
</form>
<br>
</div>
<%
